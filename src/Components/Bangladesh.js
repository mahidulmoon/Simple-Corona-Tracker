        ...
        <div> 
            ...
            <Row>
                ...
                <div>
                    ...
                    <p style={{color:'red'}}>Death: {((this.state.result.death24*100)/this.state.result.positive24).toFixed(2)}%</p>
                    ...
                    <p style={{color:'red'}}>Death: {((this.state.result.totaldeath*100)/this.state.result.totalpositive).toFixed(2)}%</p>
                </div>
                </Col>
            </Row>
        </div>
